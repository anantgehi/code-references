...
public class TestLinkedList {
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println("Offered " + l1.offer("1"));//[seven,six,1]
		System.out.println("Offered " + l1.offerLast("2"));//[seven,six,1,2]
		System.out.println("after 2 offers " + l1);

		// addLast equivalent to add(E o)
		l1.addLast("ten");//[seven,six,1,2,ten]
		l1.addLast("eleven");//[seven,six,1,2,ten,eleven]
