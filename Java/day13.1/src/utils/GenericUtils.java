...
public class GenericUtils {
	...
	/*
	 * 1. Vector<Emp> : no err 2. AL<Emp> : no err 3. HS<Emp> : javac err : HS IS
	 * Not a List 4. LHS <Emp> javac err : LHS IS Not a List 5. AL<Mgr> : no err 6.
	 * LL<SalesMgr> : no err 7. Vector<Worker> : no err 8. LL <TempWorker> :no err
	 */
