...
//add public static method to chk for dup chasis no
	...
	public static Vehicle validateAllInputs(int chasisNo, String color, double price, String manufactureDate,
			String category, Vehicle[] showroom) throws VehicleHandlingException, ParseException {
	...
	public static Vehicle findByChasisNo(int chasisNo, Vehicle[] vehicles) throws VehicleHandlingException
	{
